...
public class AirQualityLoggingAspect {
    ...
    public void AQControllerLayer(){
        System.out.println("The pointcut is executed for the controller methods of air quality class");
    }
    @Pointcut("execution(* com.environment.environmentDataAnalysis.Service.AirQualityService.*(..))")
    public void AQServiceLayer(){
        System.out.println("The pointcut is executed for the service methods of air quality class");
    }
